 ...
 */
function block_tb_leeloolxpvimeo_nav_updateconf() {
    if (isset(get_config('block_tb_leeloolxpvimeo_nav')->license)) {
    ...
    if ($infoleeloolxp->status != 'false') {
        ...
        set_config('settingsjson', base64_encode($output), 'block_tb_leeloolxpvimeo_nav');
        return;
    }
